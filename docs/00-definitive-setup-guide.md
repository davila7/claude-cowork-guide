...
> Based on [@witcheer's comprehensive guide](https://x.com/witcheer), compiled from Anthropic's official Help Center documentation, the Cowork blog post, the knowledge-work-plugins GitHub repository, CNBC reporting, VentureBeat coverage, and multiple independent reviews.
...
| Date | Milestone |
|------|-----------|
| January 12, 2026 | Cowork launches |
| January 16, 2026 | Expanded to Pro subscribers |
| January 23, 2026 | Expanded to Team and Enterprise |
| January 30, 2026 | 11 open-source plugins launched |
| February 10, 2026 | Windows (x64) support added |
| February 24, 2026 | Major enterprise update: new plugins, connectors, and admin controls |
...
**Backup first.** Before your first real task, back up anything in the folders you plan to share:
...
Example for a `projects/client-a/` folder:
...
> Templates: [global-instructions.md](../templates/global-instructions.md) | [folder-instructions.md](../templates/folder-instructions.md)
...
4. Or browse at [claude.com/plugins](https://claude.com/plugins)

### What's available (as of February 27, 2026)

Anthropic open-sourced 11 plugins on January 30 and shipped additional plugins on February 24. The open-source repo is at [github.com/anthropics/knowledge-work-plugins](https://github.com/anthropics/knowledge-work-plugins).
...
> Full plugin details and tier list: [Plugins and connectors](04-plugins-and-connectors.md) | [Plugins tier list](08-plugins-tier-list.md)
...
Watch what happens. Answer the questions. Iterate. The best early tasks are:
...
Cowork supports recurring tasks. Type `/schedule` in any Cowork task, or click **"Scheduled"** in the left sidebar. Tasks only run while your computer is awake and the app is open.
...
- [@witcheer's original thread](https://x.com/witcheer)
- CNBC reporting, VentureBeat coverage, and independent reviews

---

[Back to index](../README.md) | [Next: Getting started](01-getting-started.md)
